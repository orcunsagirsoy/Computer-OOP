...
public class Main
{
    ...
    private static void testComputer1()
    {
        ...
        {
            throw new RuntimeException(String.format("Your price calculation is wrong! Expected: %.2f Found: %.2f", estimatedTotalPrice, totalPrice));
        }
        ...
        {
            throw new RuntimeException(String.format("Your power calculation is wrong! Expected: %d Found: %d", estimatedTotalPower, totalPower));
        }
    }
